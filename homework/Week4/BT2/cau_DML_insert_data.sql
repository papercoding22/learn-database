...
-- ============================================================
-- 1. KHOA (5 dong) - Nhap truoc, TRGKHOA de NULL vi GV chua co
-- ============================================================
...
-- Cap nhat TRGKHOA sau khi da co du lieu GIAOVIEN
...
UPDATE KHOA SET TRGKHOA = NULL   WHERE MAKHOA = 'KTMT'; -- Chua co truong khoa

-- ============================================================
-- 3. LOP (3 dong) - TRGLOP de NULL vi HOCVIEN chua co
-- ============================================================
...
-- Cap nhat TRGLOP sau khi da co du lieu HOCVIEN
...
-- ============================================================
-- KIEM TRA DU LIEU SAU KHI NHAP
-- ============================================================
SELECT 'KHOA'      AS Bang, COUNT(*) AS SoDong FROM KHOA
UNION ALL
...
UNION ALL
SELECT 'DIEUKIEN', COUNT(*) FROM DIEUKIEN
UNION ALL
SELECT 'HOCVIEN',  COUNT(*) FROM HOCVIEN
UNION ALL
SELECT 'GIANGDAY', COUNT(*) FROM GIANGDAY
UNION ALL
SELECT 'KETQUATHI',COUNT(*) FROM KETQUATHI;